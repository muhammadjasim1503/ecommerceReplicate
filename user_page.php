...
$catList = $categories->displayCategory();
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                <div class="list-group-item checkbox">
                                    <label><input type="radio" name = "categories" class="common_selector" value="" checked = "checked"> All</label>
                                </div>
                                    <?php
                                    if (count($catList)) {
                                    ...
                                    ?>
                                            <div class="list-group-item checkbox">
                                                <label><input type="radio" name = "categories" class="common_selector categories" value="<?php echo ucfirst($c['id']) ?>"> <?php echo ucfirst($c['title']) ?></label>
                                            </div>
                                    <?php
                                        }
                                    }
