...
$addCategories = new Categories();

$display = $addCategories->displayCategory();
// Update product in  table
if (isset($_POST['update'])) {
    $addCategories->updateRecord($_POST);
}
if (isset($_GET['deleteId']) && !empty($_GET['deleteId'])) {
    $deleteId = $_GET['deleteId'];
    $addCategories->delete($deleteId);
}
?>
<html lang="en">
...
";
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Display All Categories</h1>
                </div>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            &nbsp;
                                                            <a href="categories.php?deleteId=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm" onclick="confirm('Are you sure want to delete this record')"><i class="fas fa-trash-alt"></i> Delete</a>
                                                        </td>
                                                    </tr>
                                            <?php }
                                            } ?>
