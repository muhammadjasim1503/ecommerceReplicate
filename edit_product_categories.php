...
$delCat = new Categories();

$display = $addProducts->displayProduct();
// Update product in  table
if (isset($_POST['update'])) {
    $addProducts->updateCategory($_POST);
}
...
if (isset($_GET['catId']) && !empty($_GET['catId'])){
    $catId = $_GET['catId'];
    $editProduct = $addProducts->displayProductByCat($catId);
    if (!count($editProduct)>0){
        $delCat->delete($catId);
        header("location: product.php?msg5=updateAndDelete");
    }

    // if(count($editProduct)<1){
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    elseif (isset($_GET['catId']) ){
                                        ...
                                        Listed products category needs to be changed before deleting the category
                                        <button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button>
                                         </div>";
                                    }
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form action="edit_product_categories.php" method="POST">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            console.log(edit_id);
            $.ajax({
                url: "update_product_category.php",
                type: "post",
                data: {
                    edit_id: edit_id
                },
