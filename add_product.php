...
$dispCategory = $category->displayCategory();
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="row g-3" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-4">
                                            <label for="inputZips" class="form-label">Display</label>
                                        ...
                                        <div class="col-md-4">
                                            <select name="category" id="">
                                                <?php
                                            foreach($dispCategory as $disp){
                                                ?>
                                                <option value="<?php  echo $disp['id']; ?>"> <?php echo $disp['title']; ?></option>
                                              <?php 
                                            }
                                            ?>''
                                            </select>
