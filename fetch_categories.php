 ...
 if($total_row > 0)
 {
  foreach($res as $row)
  {
   ...
   <div class="card h-100 my-2">
    ...
    //    Do the changes here tomorrow and remove this line completely
       ...
       <div class="card-body">
          ...
          <button class="btn btn-sm btn-primary px-4 ms-2" name="add_to_cart" type="submit" id="button-addon2"><i class="fas fa-cart-plus"></i> Display the products</button>
        </div>
